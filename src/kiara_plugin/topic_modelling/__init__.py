...
"""Top-level package for kiara_plugin.topic_modelling."""
...
KIARA_METADATA = {
    ...
    "description": "Kiara modules for: topic_modelling",
    "references": {
        "source_repo": {
            "desc": "The module package git repository.",
            "url": "https://github.com/DHARPA-Project/kiara_plugin.topic_modelling",
        },
        "documentation": {
            "desc": "The url for the module package documentation.",
            "url": "https://DHARPA-Project.github.io/kiara_plugin.topic_modelling/",
        },
    },
    "tags": ["topic_modelling"],
    "labels": {"package": "kiara_plugin.topic_modelling"},
}

find_modules: KiaraEntryPointItem = (
    find_kiara_modules_under,
    "kiara_plugin.topic_modelling.modules",
)
find_model_classes: KiaraEntryPointItem = (
    find_kiara_model_classes_under,
    "kiara_plugin.topic_modelling.models",
)
find_data_types: KiaraEntryPointItem = (
    find_data_types_under,
    "kiara_plugin.topic_modelling.data_types",
)
find_pipelines: KiaraEntryPointItem = (
    find_pipeline_base_path_for_module,
    "kiara_plugin.topic_modelling.pipelines",
    KIARA_METADATA,
)
